...
class DatasetCOCO(Dataset):
    ...
    def load_frame(self):
        ...
        ## TODO:
        choices = self.img_metadata_classwise[class_sample]
        choices = list(set(choices) - set([query_name]))
        support_names = list(np.random.choice(choices, min(self.shot, len(choices)), replace=False))
        # support_names = []
